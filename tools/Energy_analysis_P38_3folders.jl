...
if !isdir(target2)
    println("The target suit $(target2) is not exist")
    exit("Stopped. Reason: $(target2) is not exist.")
else
    println("Monitor folder : ", target2)
end

filelist = ""
filelist = readdir(target2)
println("")
println(" The 2nd folder")
println("")
println(filelist)
println("")

for ifile in filelist
    ifolder  = string(target2,"/",ifile)
    #println("ifolder : ",ifolder)
    if isdir(ifolder)
        dirlist = readdir(ifolder)
        #println("dirlist : ",dirlist)
...
if !isdir(target3)
    println("The target suit $(target3) is not exist")
    exit("Stopped. Reason: $(target3) is not exist.")
else
    println("Monitor folder : ", target3)
end

filelist = ""
filelist = readdir(target3)
println("")
println(" The 3rd folder")
println("")
println(filelist)
println("")
